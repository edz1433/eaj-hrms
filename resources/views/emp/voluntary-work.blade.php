    ...
    <div class="flex-1 min-w-0 space-y-4">
        ...
        <div class="flex items-center gap-3">
            <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-green-100 dark:bg-green-900/30">
                <i class="fas fa-hand-holding-heart text-green-600 dark:text-green-400 text-sm"></i>
            </div>
            <div>
        ...
        <div class="overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm">
            <div class="flex items-center justify-between border-b border-border/60 bg-muted/20 px-5 py-3">
                <div class="flex items-center gap-2">
                    <i class="fas fa-plus-circle text-green-500 text-xs opacity-80"></i>
        ...
        <div class="space-y-3">
            ...
            <div class="overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm voluntaryworks-row row-{{ $vwork->id }}">
                ...
                <div class="px-5 py-3 flex flex-wrap items-center gap-x-4 gap-y-1 text-[10px] text-muted-foreground">
                    ...
                    <div class="ml-auto flex items-center gap-1.5">
                        @if($guard == 'web')
                            <a href="{{ route('voluntaryworksEdit', ['id' => $empid, 'eid' => $vwork->id]) }}"
                            ...
                            <button class="voluntaryworks_approve flex h-7 w-7 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 hover:bg-emerald-100 border border-emerald-200/60 dark:bg-emerald-950/30 transition-colors"
                                value="{{ $vwork->id }}" title="Approve">
                                <i class="fas fa-check text-[10px]"></i>
                            </button>
                            @if($vwork->status == 0)
                                <button onclick="openCancelModal({{ $vwork->id }})"
        ...
        <div class="rounded-2xl border border-dashed border-border/60 bg-muted/20 py-10 text-center">
            <i class="fas fa-hand-holding-heart text-3xl text-muted-foreground/30 mb-2"></i>
